...
export default function SessionProgress({ current, max, isSessionCompleted }: SessionProgressProps) {
  ...
  if (isSessionCompleted) {
    return (
      <div data-tour="session-progress" className="flex items-center justify-center gap-2 px-4 py-2 bg-[#FAF6F1] dark:bg-[#2A2420] border-b border-[#E8DDD0] dark:border-[#4A4038]">
  ...
  return (
    <div data-tour="session-progress" className="flex items-center gap-2 px-4 py-1.5 bg-[#FAF6F1] dark:bg-[#2A2420] border-b border-[#E8DDD0] dark:border-[#4A4038]">
      <div className="flex-1 h-[5px] rounded-full bg-[#E8DDD0] dark:bg-[#4A4038] overflow-hidden">
        <div
