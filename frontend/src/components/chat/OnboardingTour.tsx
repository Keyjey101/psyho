...
const STEPS = [
  {
    ...
    description: "Просто напиши, что тебя беспокоит. Не нужно формулировать правильно — PsyHo поймёт.",
  },
  {
    icon: Brain,
  ...
  },
  {
    ...
    description: "Задавай вопросы, проси техники, делись переживаниями. PsyHo всегда рядом.",
  },
];
