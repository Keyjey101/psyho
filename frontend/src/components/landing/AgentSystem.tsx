      ...
      <div className="mx-auto max-w-4xl">
        ...
        >
          ...
          <p className="mx-auto mt-4 max-w-xl text-[15px] leading-[1.7] text-[#8A7A6A]">
            ChatGPT, DeepSeek и другие ИИ-ассистенты отвечают с одной точки зрения — и даже
            самый продуманный промпт это не меняет: всё равно один голос, одна логика. Ника
            работает иначе: за каждым ответом — взгляды сразу нескольких терапевтических школ,
            собранные в одно тёплое и точное послание. Ты видишь Нику — за ней стоит команда.
          </p>
        </motion.div>
        ...
        >
          <p className="text-[15px] leading-[1.7] text-[#5A5048]">
            <span className="font-semibold text-[#B8785A]">Чем это отличается от ChatGPT, DeepSeek и других?</span>{" "}
            Даже с идеальным системным промптом любой ИИ-ассистент — это один голос и одна логика.
            Ника собирает взгляды сразу шести психологических школ: КПТ, юнгианский анализ, ACT, IFS,
            нарративный и соматический подходы. Каждый эксперт добавляет своё — ты получаешь
